...
class ManagementProfileService extends abstract_service_1.default {
    // Get profile
    getProfile(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { user_id } = req.management;
            const ManagementAdministrationModel = this.Model.ManagementAdministrationModel();
            ...
            const { password_hash, created_by } = profile, userData = __rest(profile, ["password_hash", "created_by"]);
            return {
                success: true,
    ...
    editProfile(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                // if (rest.name && rest.name.toLowerCase() !== user?.name.toLowerCase()) {
                //   const genUser = Lib.generatelogin_id(rest.name);
                //   let login_id = genUser;
                //   let prefix = 1;
                //   while (
                ...
                //   await managementModel.updateManagement({ is_2fa_on }, { user_id });
                //   // await this.insertmanagementAudit(trx, {
                //   //   details: `management User(${user_id}) has updated 2FA settings to ${is_2fa_on}.`,
    ...
    changePassword(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const isOldPasswordValid = yield lib_1.default.compareHashValue(old_password, management.password_hash);
                ...
                // await this.insertmanagementAudit(trx, {
                //   details: `management User ${management.login_id}(${user_id}) has changed their own password.`,
...
exports.default = ManagementProfileService;
