...
const managementProfile_service_1 = __importDefault(require("../services/managementProfile.service"));
const managementAdministration_validator_1 = __importDefault(require("../utils/validator/managementAdministration.validator"));
class ManagementProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new managementProfile_service_1.default();
...
exports.default = ManagementProfileController;
