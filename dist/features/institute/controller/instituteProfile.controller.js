...
const instituteProfile_service_1 = __importDefault(require("../services/instituteProfile.service"));
const instituteAdministration_validator_1 = __importDefault(require("../utils/validator/instituteAdministration.validator"));
class InstituteProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new instituteProfile_service_1.default();
...
exports.default = InstituteProfileController;
