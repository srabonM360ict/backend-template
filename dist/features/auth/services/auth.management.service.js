...
class ManagementAuthService extends abstract_service_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const checkUser = yield userModel.getSingleCommonAuthUser({
                    ...
                    email: login_id_or_email,
                    login_id: login_id_or_email,
                });
                if (!checkUser) {
                    return {
                        success: false,
                ...
                if (rest.is_2fa_on) {
                    const checkOtp = yield CommonModel.getOTP({
                        ...
                        type: constants_1.OTP_TYPES.verify_management,
                        interval: "1",
                    });
                    if (checkOtp.length) {
                        return {
                    ...
                    //   details: `management User ${checkUser.login_id}(${checkUser.email}) has logged in.`,
    ...
    forgetPassword(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token_verify = lib_1.default.verifyToken(token, config_1.default.JWT_SECRET_MANAGEMENT);
            if (!token_verify) {
                return {
                    success: false,
...
exports.default = ManagementAuthService;
