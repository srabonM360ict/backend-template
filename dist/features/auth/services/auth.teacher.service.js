...
class TeacherAuthService extends abstract_service_1.default {
    //login
    loginService(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const checkUser = yield userModel.getSingleCommonAuthUser({
                    schema_name: "teacher",
                    table_name: constants_1.USER_AUTHENTICATION_VIEW.TEACHER,
                    login_id: login_id,
                });
                if (!checkUser) {
                    return {
                ...
                if (rest.is_2fa_on) {
                    const checkOtp = yield CommonModel.getOTP({
                        ...
                        type: constants_1.OTP_TYPES.verify_teacher,
                        interval: "1",
                    });
                    if (checkOtp.length) {
                        return {
                    ...
                    const token = lib_1.default.createToken(token_data, config_1.default.JWT_SECRET_TEACHER, constants_1.LOGIN_TOKEN_EXPIRES_IN);
                    return {
                        success: true,
                        code: this.StatusCode.HTTP_OK,
    ...
    forgetPassword(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token_verify = lib_1.default.verifyToken(token, config_1.default.JWT_SECRET_TEACHER);
            if (!token_verify) {
                return {
                    success: false,
...
exports.default = TeacherAuthService;
