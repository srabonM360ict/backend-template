...
const auth_student_service_1 = __importDefault(require("../services/auth.student.service"));
class StudentAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new auth_student_service_1.default();
        // login
