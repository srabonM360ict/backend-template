...
const auth_management_service_1 = __importDefault(require("../services/auth.management.service"));
class ManagementAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new auth_management_service_1.default();
        // login
...
exports.default = ManagementAuthController;
