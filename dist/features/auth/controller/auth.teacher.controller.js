...
const auth_teacher_service_1 = __importDefault(require("../services/auth.teacher.service"));
class TeacherAuthController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new auth_teacher_service_1.default();
        // login
