...
const studentProfile_service_1 = __importDefault(require("../services/studentProfile.service"));
const studentProfileValidator_1 = require("../utils/validator/studentProfileValidator");
class StudentProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new studentProfile_service_1.default();
        this.validator = new studentProfileValidator_1.StudentProfileValidator();
        //get profile
