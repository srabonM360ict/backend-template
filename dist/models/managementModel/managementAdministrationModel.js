...
class ManagementAdministrationModel extends schema_1.default {
    constructor(db) {
        super();
        this.db = db;
    }
    ...
    roleList(limit_1, skip_1) {
        return __awaiter(this, arguments, void 0, function* (limit, skip, total = false) {
            ...
            const data = yield this.db("roles as rl")
                ...
                .leftJoin("management as au", "au.user_id", "rl.created_by")
            ...
            if (total) {
                count = yield this.db("roles as rl")
                    ...
                    .join("management as au", "au.user_id", "rl.created_by")
                    .joinRaw("LEFT JOIN dbo.user u ON u.id = au.user_id");
            }
    ...
    getSingleRole(_a) {
      ...
      case when exists (
        select 1
        from ${this.MANAGEMENT_SCHEMA}.role_permissions rp
        ...
        from ${this.MANAGEMENT_SCHEMA}.role_permissions rp
        left join ${this.MANAGEMENT_SCHEMA}.permissions per
    ...
    permissionsList(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.db("permissions as per")
                ...
                .leftJoin("management as au", "au.user_id", "per.created_by")
                .joinRaw("LEFT JOIN dbo.user u ON u.id = au.user_id")
...
exports.default = ManagementAdministrationModel;
